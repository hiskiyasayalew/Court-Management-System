  ...
  data.append("application", new Blob([JSON.stringify({
    fullName, email, phone, address, role, reason,
    education, workExperience, additionalInfo
  ...
  await fetch("http://localhost:8080/api/admin/applications", {
    method: "POST",
    body: data,
  });
