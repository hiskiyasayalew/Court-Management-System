  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4 sm:p-6 lg:p-8 relative">
      ...
      >
        {/* Left side - Image */}
        <motion.section 
          className="flex-shrink-0 w-full max-w-sm md:max-w-md lg:max-w-xl mb-6 lg:mb-0"
          ...
          <form className="space-y-3 sm:space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className={`w-full flex justify-center items-center py-2.5 sm:py-3 px-4 border border-transparent rounded-lg shadow-sm text-white font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 text-sm sm:text-base ${
